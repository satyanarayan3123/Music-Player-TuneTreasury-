...
async function main() {
    ...
    document.getElementById('fb-share-button').onclick = function () {
        ...
        let fbShareUrl = "https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(url);  // Create the Facebook share URL
    ...
    document.getElementById('twitter-share-button').onclick = function() {
        ...
        let twitterShareUrl = "https://twitter.com/intent/tweet?text=" + encodeURIComponent(text) + "&url=" + encodeURIComponent(url);  // Create the Twitter share URL
    ...
    document.getElementById('instagram-share-button').onclick = function() {
        let url = window.location.href;  // Get the current page URL
        let text = "Check out this awesome song!";  // The text for the LinkedIn post
        let instagramShareUrl = "https://www.instagram.com/" + encodeURIComponent(url);  // Create the Instagram share URL
